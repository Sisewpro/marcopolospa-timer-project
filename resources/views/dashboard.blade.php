        ...
        <div class="mx-auto sm:px-8 lg:px-10">
            ...
            <div
                ...
                <x-timer-card :id="$card->id" :cardName="$card->card_name"
                    :therapistName="$card->therapist ? $card->therapist->name : 'None'" :time="$card->time"
                    :status="$card->status" :customer="$card->customer ? $card->customer : 'Customer'"
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <form id="editForm" method="POST" action="{{ route('timer-cards.update', isset($card) ? $card->id : '') }}">
                ...
                <div class="mt-2">
                    ...
                    <x-text-input id="card_name" name="card_name" placeholder="Nama Locker"
                        class="input input-primary mb-2 w-full" />
                </div>
                ...
                <div class="mt-2">
                    ...
                    <x-text-input id="customer" name="customer" placeholder="Customer"
                        class="input input-primary mb-2 w-full" />
                </div>
