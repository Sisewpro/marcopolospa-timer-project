                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-600">
                                        <?php echo e($therapist->phone_number); ?>

                                    </td>
                                    <?php if(auth()->user()->role !== 'admin'): ?>
                                    <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-600">
                                        <span
                                            class="inline-flex items-center justify-center <?php echo e($therapist->status === 'active' ? 'text-green-500' : 'text-red-700'); ?> font-bold">
                                            <?php echo e($therapist->status); ?>
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-200 dark:border-gray-600">
                                        <span
                                            class="inline-flex items-center justify-center <?php echo e($therapist->availability_status === 'available' ? 'text-green-500' : 'text-red-500'); ?> font-bold">
                                            <?php echo e($therapist->availability_status); ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\spa-counter-rev-ver-1\resources\views/active_therapists/index.blade.php ENDPATH**/ ?>