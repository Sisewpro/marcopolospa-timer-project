<form action="<?php echo e(route('timer-cards.start', $id)); ?>" method="POST"
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-2">
            <span id="editButton_<?php echo e($id); ?>" class="cursor-pointer text-base hover:text-warning"
    ...
    <div>
        <input type="text" id="customer_<?php echo e($id); ?>" name="customer" class="w-full text-center p-2 input rounded"
    ...
    <div class="flex justify-center space-x-2 items-center">
        ...
        <div class="dropdown">
            ...
            <ul data-card-id="<?php echo e($id); ?>" tabindex="0"
...
document.addEventListener('DOMContentLoaded', function() {
    initializeTimerCard("<?php echo e($id); ?>", "01:30:00", false);
});
