<form action="<?php echo e(route('timer-cards.start', $id)); ?>" method="POST" onsubmit="event.preventDefault();"
    class="bg-base-100 shadow-md rounded-lg pt-4 pb-2 px-3 max-w-sm mx-auto">
    <?php echo csrf_field(); ?>
    <div class="flex justify-between items-center">
        <h2 class="text-lg font-semibold text-base-500"><?php echo e($cardName); ?></h2>
        <div class="flex space-x-2">
            <span id="editModal_<?php echo e($id); ?>" class="cursor-pointer text-base hover:text-primary"
                onclick="openEditModal('<?php echo e($id); ?>', '<?php echo e($cardName); ?>', '<?php echo e($therapistName); ?>', '<?php echo e($time); ?>')">
                <!-- Ikon Edit -->
    ...
    <div class="text-center mt-1">
        ...
        <div class="-mt-2">
            <progress id="progressBar_<?php echo e($id); ?>" class="progress progress-warning w-3/5 h-2" value="100"
                max="100"></progress>
        </div>
    </div>
    ...
    <div class="flex justify-center space-x-2 items-center mt-1">
        <button id="startStopButton_<?php echo e($id); ?>" type="button"
...
document.addEventListener('DOMContentLoaded', function() {
    initializeTimerCard("<?php echo e($id); ?>", "<?php echo e($time); ?>", "<?php echo e($status); ?>", "<?php echo e($startTime); ?>");
});
...
function initializeTimerCard(cardId, initialTime, status, startTime) {
    ...
    function startTimer() {
        ...
        fetch(`/timer-cards/${cardId}/start`, {
            ...
            body: JSON.stringify({
                customer: "<?php echo e($customer); ?>", // Ambil value dari backend
                time: totalSeconds,
                status: 'Running'
            })
        });
