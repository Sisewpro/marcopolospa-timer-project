<form action="<?php echo e(route('timer-cards.start', $id)); ?>" method="POST" class="bg-base-100 shadow-md rounded-lg p-4 max-w-sm mx-auto">
    ...
    <div class="text-center mt-2">
        ...
        <div class="text-3xl font-mono countdown mt-3">
            <span id="hours_<?php echo e($id); ?>" style="--value:floor(<?php echo e($time); ?> / 3600);"></span> :
            <span id="minutes_<?php echo e($id); ?>" style="--value:floor(<?php echo e($time); ?> / 60 % 60);"></span> :
            <span id="seconds_<?php echo e($id); ?>" style="--value:floor(<?php echo e($time); ?> % 60);"></span>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\lurker\resources\views/components/timer-card.blade.php ENDPATH**/ ?>