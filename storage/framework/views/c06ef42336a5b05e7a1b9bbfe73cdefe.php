<nav x-data="{ open: false }" class="bg-base-100 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
...
<?php endif; ?>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex relative group">
                    ...
                    <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('master'),'active' => request()->routeIs('master'),'class' => 'inline-flex items-center cursor-pointer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('master')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('master')),'class' => 'inline-flex items-center cursor-pointer']); ?>
...
</nav><?php /**PATH C:\laragon\www\spa-counter-rev-ver-1-development\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>