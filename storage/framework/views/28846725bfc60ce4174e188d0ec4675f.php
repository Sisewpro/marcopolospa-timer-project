    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($rekap->timerCard->card_name ?? 'No Card'); ?></td>
                <!-- Access the timer card name via relation, fallback value if missing -->
                <td><?php echo e($rekap->therapist_name ?? 'N/A'); ?></td> <!-- therapist_name from rekaps table -->
                <td><?php echo e($rekap->customer ?? 'N/A'); ?></td> <!-- customer from rekaps table -->
                <td><?php echo e($rekap->time ?? 'No session time'); ?></td> <!-- session time from rekaps table -->
                <td><?php echo e($rekap->formatted_date); ?></td>
                <td><?php echo e($rekap->formatted_time); ?></td>
            </tr>
...
</html><?php /**PATH D:\laragon\www\marcopolospa-timer-project\resources\views/pdf/rekaps.blade.php ENDPATH**/ ?>